...
const searchResults = document.querySelectorAll("[data-search-result]"); // renamed to searchResults
        ...
        searchTimeout = setTimeout(()=>{
            fetchData(url.geo(searchField.value), function(locations){
                ...
                searchResults.forEach(result => {
                    ...
                    result.innerHTML = `<ul class="view-list" data-search-list></ul>`;
                });
                ...
                for(const {name, lat, lon, country, state} of locations){
                    ...
                    searchItem.innerHTML = `
                        ...
                        <div>
                            ...
                            <p class="label-2 item-subtitle">${state || ""} ${country} GB</p>
                        </div>

                        <a href="#/weather?lat=${lat}&lon=${lon}" class="item-link has-state" data-search-toggler
                        arial-label="${name} weather"></a>
                `;

                searchResults[0].querySelector("[data-search-list]").appendChild(searchItem);
         ...
         fetchData(url.forecast(lat,lon),function(forecast){
            ...
            hourlySection.innerHTML=`
                    ...
                    for(const [index, data] of forecastList.entries()){
                        ...
                        tempLi.classList.add("slider-list");
                    ...
                    <div class="card card-sm slider-card">
                                    ...
                                    <p class="body-3">${module.mps_to_kmh(windSpeed.toPrecision(1))} km/h</p>
                                </div>`;
           ...
           container.classList.contains("fade-in") ?? container.classList.add("fade-in");
         });
